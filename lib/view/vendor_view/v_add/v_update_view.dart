...
class VUpdateView extends StatefulWidget {
  final String title;

  const VUpdateView({super.key, required this.title});

  @override
  State<VUpdateView> createState() => _VAddViewState();
}

class _VAddViewState extends State<VUpdateView> {
  @override
  Widget build(BuildContext context) {
    ...
    return EllipsisScaffold(
      body: Column(
        children: [
          CustomAppbar(title: "Update ${widget.title}"),
          Expanded(
            child: Padding(
