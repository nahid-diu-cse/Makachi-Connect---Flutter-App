...
class TodayTicket extends StatefulWidget {
  const TodayTicket({super.key});

  @override
  State<TodayTicket> createState() => _TodayTicketState();
}

class _TodayTicketState extends State<TodayTicket> {
